...
module "monitor_alert" {
  ...
  source                  = "../modules/functions-alert-for-teams"
  name                    = "devbumllogmainanalytics"
  location                = var.location
  resource_group_name     = module.naming.resource_group.name
  resources_to_monitor_ids = ["/subscriptions/bd6863ee-44db-4efb-80c1-b850c53a8bf9/resourceGroups/dev-buml-rg/providers/Microsoft.Web/sites/devbumlsurverypdf"]
